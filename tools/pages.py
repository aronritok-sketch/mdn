...
SHOP = '''    <section class="iu-section page-head"><div class="iu-row"><div class="iu-column iu-column-1-1">
    ...
    <!-- 1-4|3-4: mandala/filter (saját blokk) + [products class="mainquery"] -->
    <section class="iu-section" style="padding-top:var(--space-6)"><div class="iu-row">
      <div class="iu-column iu-column-1-4"><aside class="iu-woocommerce-filter mandala-filter" id="filters" data-filters aria-label="Szűrők"></aside></div>
      <div class="iu-column iu-column-3-4">
        ...
        <div class="quick-filters" data-quick role="group" aria-label="Gyors szűrések"></div>
